...
class PneumaticMotor extends Motor {
    ...
    @Override
    public String toString() { return "Pneumatic motor={model:" + model + ",power:" + power + "}"; }
}
...
class HydraulicMotor extends Motor {
    ...
    @Override
    public String toString() { return "Hydraulic motor={model:" + model + ",power:" + power + "}"; }
}
...
class ElectricMotor extends Motor {
    ...
    @Override
    public String toString() { return "Electric motor={model:" + model + ",power:" + power + "}"; }
}
...
class WarpDrive extends Motor {
    ...
    @Override
    public String toString() { return "Warp motor={model:" + model + ",power:" + power + "}"; }
}
